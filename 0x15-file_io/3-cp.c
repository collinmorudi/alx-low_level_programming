...
/**
 * __exit - prints error messages and exits with the exit value
 * @error: num is either exit value or represent file descriptor
 * @s: str is a file name or file names
 * @fd: file descriptor
 * Return: 0 on pass
 **/
